...
@section('content')
    <div class="flex justify-center items-center font-[HammersmithOne-Regular] overflow-auto px-30 py-8 max-md:p-10 max-sm:p-5"
        ...
        <div
            ...
            <div class="flex flex-col gap-6 mb-4 md:flex-row md:items-center md:justify-between relative z-10 flex-none">
                ...
                <div
                    class="flex flex-col gap-5 md:flex-row md:items-center bg-white/80 backdrop-blur-sm rounded-xl p-2 shadow-lg border border-stone-200">
                    ...
                    <div class="flex gap-2">
                        ...
                        <select name="filter" id="filterSelect"
                            class="w-full md:w-auto px-2 py-2 border-2 border-stone-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-stone-300 focus:border-stone-300 bg-white transition-all duration-300 hover:shadow-md">
