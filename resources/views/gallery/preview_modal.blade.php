<div id="preview-image-modal" class="fixed inset-0 z-50 flex items-center justify-center font-[HammersmithOne-Regular]"
    ...
    <div class="modal-content bg-white rounded-xl shadow-2xl p-8 relative">
        <button id="close-preview-image-modal"
            class="absolute top-2 right-2 text-gray-500 hover:text-gray-800 text-2xl font-bold">&times;</button>
        <h3 class="text-xl font-bold mb-4 text-blue-700">Preview Full Image</h3>
        <img src="" alt="Preview Full Image" id="previewImageFull"
